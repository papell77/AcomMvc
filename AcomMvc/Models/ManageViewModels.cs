...
namespace AcomMvc.Models
{
    ...
    public class ManageDataViewModel
    {
        ...
        [MaxLength(128, ErrorMessage="La lunghezza del nome non può superare i {0} caratteri")]
        public string firstName { get; set; }
        [Display(Name = "Cognome")]
        [Required(ErrorMessage = "Inserire Cognome")]
        [MaxLength(128, ErrorMessage = "La lunghezza del cognome non può superare i {0} caratteri")]
        public string surname { get; set; }
        [EmailAddress(ErrorMessage="Campo email non valido")]
        public string Email { get; set; }
        [Required(ErrorMessage = "Inserire UserName")]
        [MaxLength(128, ErrorMessage = "La lunghezza dello UserName non può superare i {0} caratteri")]
