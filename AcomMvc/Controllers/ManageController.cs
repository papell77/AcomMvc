    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.DataSuccess ? "Dati modificati con successo"
        ...
        //GET: /Manage/ManageData
        public ActionResult ManageData() 
        {
            var userId = User.Identity.GetUserId();
            var ctx = new AcomMvcContext();
            var query = ctx.Users.Find(userId);
            var model = new ManageDataViewModel 
            {
                Id=query.Id,
            ...
            ViewBag.Role = UserManager.GetRoles(model.Id);

            return View(model);
        }

        //POST: /Manage/ManageData
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> ManageData(ManageDataViewModel user)
        {
            ...
            try
            {
                EditedUser = ctx.Users.Find(user.Id);
            }
            catch (Exception ex)
            {
            ...
            EditedUser.fullName = user.surname + " " + user.firstName;
            ...
            else
            {
                ...
                message = ManageMessageId.DataSuccess;
                return RedirectToAction("Index", new { message = message });
            }
        }

        //GET: /Manage/GetJsonUsers
